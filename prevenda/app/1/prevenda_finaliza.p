...
find prevenda where 
    prevenda.precod = ttentrada.precod and 
    prevenda.etbcod = ttentrada.etbcod
    no-error.

if not avail prevenda
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
...
if prevenda.dtfechamento <> ?
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "Prevenda ja foi finalizada".
...
create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "prevenda salvo".
